...
function M.get(c)
  return {
    ...
    leetcode_calendar_50 = { fg = c.success },
    leetcode_calendar_60 = { fg = c.success },
    leetcode_calendar_70 = { fg = c.success },
    leetcode_calendar_80 = { fg = c.success },
    leetcode_calendar_90 = { fg = c.success },
    leetcode_calendar_100 = { fg = c.success },
