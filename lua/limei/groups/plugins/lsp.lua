...
function M.get(c)
  return {
    ...
    RenameMatch = { fg = c.transformation, underline = true },
    ...
    SagaConstructor = { fg = c.keyword },
    SagaConstant = { fg = c.constant },
    SagaMacro = { link = "SagaConstant" },
    SagaString = { fg = c.string },
    SagaNumber = { fg = c.number },
    SagaBoolean = { fg = c.boolean },
    SagaEnum = { fg = c.boolean },
