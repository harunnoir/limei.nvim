...
function M.get(c)
  return {
    ...
    SagaConstructor = { fg = c.keyword_color },
    SagaConstant = { fg = c.constant_color },
    SagaMacro = { link = "SagaConstant" },
    SagaString = { fg = c.string_color },
    SagaNumber = { fg = c.number_color },
    SagaBoolean = { fg = c.olive },
    SagaEnum = { fg = c.olive },
