...
function M.get(c)
  return {
    ...
    SagaFileName = { fg = c.wheat },
    SagaFolderName = { fg = c.steel },
    ...
    TroubleIndent = { fg = c.indent_static },
    TroubleFilename = { fg = c.wheat },
    ...
    TinyInlineDiagnosticVirtualTextInfo = { fg = c.steel_dim },
    TinyInlineDiagnosticVirtualTextHint = { fg = c.mist_dim },
