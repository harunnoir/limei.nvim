...
check(contrast(palette.fg, palette.bg) >= 7, "primary foreground contrast is below 7:1")
for _, role in ipairs({ "variable", "callable", "keyword", "string", "number", "type", "constant", "boolean" }) do
